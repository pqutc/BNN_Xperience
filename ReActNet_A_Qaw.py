...
class ReactnetNoLoop(nn.Module):
    def __init__(self, alpha=0.25, num_classes=10):
        super(ReactnetNoLoop, self).__init__()
        ...
        # First convolution
        self.conv1 = firstconv3x3(3, 32, 1)
        
        # Sequential Blocks (explicit)
        self.block1 = BasicBlock(32, 64, alpha, beta1, beta2, 1)
        ...
        self.block2 = BasicBlock(64, 128, alpha, beta1, beta2, 2)
        ...
        self.block12 = BasicBlock(128, 256, alpha, beta1, beta2, 2)
